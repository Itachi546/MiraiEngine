...
namespace mirai {
    ...
    void FrustumPlanes::create_from_matrix(const glm::mat4 &m) {
    ...
    void FrustumPoints::create_from_matrix(const glm::mat4 &inv_m) {
        calculate_frustum_corners(inv_m, points);
    }
