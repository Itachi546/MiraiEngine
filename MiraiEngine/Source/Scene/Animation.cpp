...
namespace mirai {
    ...
    AnimationPlayer::AnimationPlayer(SkeletalAsset *skeletal_asset) : skeletal_asset(skeletal_asset), blend_duration(0.2f), blend_time(0.2f), paused(false) {
        ...
        target_animation_state.clip_index = K_INVALID_ANIMATION_CLIP;
